...
public class AlivcShowMoreDialog extends Dialog {
    ...
    private int fullModeWidth = DensityUtil.dip2px(getContext(),248);
...
//        setLayoutBySreenMode(screenMode);
    ...
    public void setContentView(@NonNull View view) {
        ...
        if (mContentView instanceof SelectSeriesView){
            fullModeWidth = DensityUtil.dip2px(getContext(),375);
        }else {
            fullModeWidth = ScreenUtils.getWidth(getContext()) / 2;
        }
    }
