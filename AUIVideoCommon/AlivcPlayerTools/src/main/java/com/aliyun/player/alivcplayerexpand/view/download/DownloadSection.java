...
public class DownloadSection extends StatelessSection {
    ...
    public void onBindItemViewHolder(ViewHolder holder, int position) {
        ...
        ImageLoader.loadImg(mediaInfo.getCoverUrl(), itemViewHolder.ivVideoCover);
    ...
    private static class SectionItemViewHolder extends ViewHolder {
    ...
    private static class DownloadInfoItemViewHolder extends ViewHolder {
