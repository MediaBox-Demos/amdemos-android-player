...
//    private boolean mIsBeingDragged = false;
    ...
    private static final AccessibilityDelegateCompat ACCESSIBILITY_DELEGATE = new AccessibilityDelegateCompat();
    ...
    public HVScrollView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mScrollOrientation = a.getInt(R.styleable.HVScrollView_scrollOrientation, SCROLL_ORIENTATION_HORIZONTAL);
