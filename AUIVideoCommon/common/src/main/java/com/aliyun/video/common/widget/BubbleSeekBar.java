...
import static com.aliyun.video.common.widget.BubbleUtils.dp2px;
import static com.aliyun.video.common.widget.BubbleUtils.sp2px;
...
public class BubbleSeekBar extends View {
    ...
    public BubbleSeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mSectionPointRadius = a.getDimensionPixelSize(R.styleable.BubbleSeekBar_bsb_track_section_point_size,
                mTrackSize);
        ...
        mSectionPointColor = a.getColor(R.styleable.BubbleSeekBar_bsb_track_section_point_color,
                ContextCompat.getColor(context, R.color.colorAccent));
...
//                }
                mPaint.setColor(mSectionPointColor);
                // sectionMark
