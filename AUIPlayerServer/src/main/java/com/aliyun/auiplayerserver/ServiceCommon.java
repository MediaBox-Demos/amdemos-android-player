...
public class ServiceCommon {
    ...
    public static String GET_RANDOM_USER = HOST + "/user/randomUser";

    public static String GET_VIDEO_LIST_INFO = HOST + "/vod/getRecommendVideoList";

    public static String GET_LIVE_PLAY_STS = HOST + "/player/getLiveEncryptSts";

    public static String GET_VIDEO_PLAY_DEMO_STS = HOST = "/demo/getSts";
