...
import com.aliyun.vodplayerview.fragment.PlayBaseFragment;
...
public class AliyunPlayerTypeEditActivity extends AppCompatActivity implements View.OnClickListener {
     ...
     * 当前Fragment
     */
    private PlayBaseFragment mCurrentFragment;

    /**
     * 播放方式Fragment
     */
    private PlayBaseFragment mAliyunPlayerTypeUrlFragment,mAliyunPlayerTypeStsFragment,mAliyunPlayerTypeMpsFragment,mAliyunPlayerTypeAuthFragment,mAliyunPlayerTypeLiveStsFragment;
    /**
     * 默认配置
     */
     ...
     * 根据不同的播放方式切换Fragment
     */
    private void switchFragment(PlayBaseFragment targetFragment) {
